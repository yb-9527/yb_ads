...
public class SplashAdLoader extends BaseAdLoader<SplashAdListener> {
    ...
    public SplashAdLoader(Context context, GAdSlot adSlot, SplashAdListener loaderListener,int fetchTimeout) {
        super(context,adSlot, loaderListener);
        this.fetchTimeout = fetchTimeout;
    }

    @Override
    protected IPlatformLoader<SplashAdLoader> createPlatformLoader(Context context, GAdInfo jAdInfo) {
        try {
            if (jAdInfo!=null){
